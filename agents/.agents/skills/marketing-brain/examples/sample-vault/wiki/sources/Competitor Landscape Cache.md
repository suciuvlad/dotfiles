...
**Status: pending.** This note becomes the snapshot of https://www.example.com's competitive landscape once the marketing-brain skill runs the DataForSEO `competitors_domain` pull plus per-keyword SERP top-10 research. Tiered by direct keyword and intent overlap with Demo Growth Co's site.
...
The closest competitors. They target the same intent and share most of Demo Growth Co's priority SERPs.
...
- Tier assignments may shift after [[Days 1-5 GSC Diagnostic and Triage]] reveals which queries actually drive Demo Growth Co's residual traffic.
