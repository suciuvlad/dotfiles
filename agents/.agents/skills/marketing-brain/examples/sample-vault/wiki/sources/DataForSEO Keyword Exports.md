...
- `site-ranked-keywords-<domain>-YYYY-MM-DD.json` — full ranked-keyword set for https://www.example.com
...
If temporary DataForSEO credentials were used for the initial pull, recommend rotating the password once Demo Growth Co verifies the pull. The vault never persists credentials per [[CODEX|CODEX rule]].
