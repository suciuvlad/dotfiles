...
Primary measurement source for Demo Growth Co. Without GSC access, every recommendation in this brain is advisory only. Status: access pending from [[Demo Growth Co]].

## Required Properties

- Domain property for `https://www.example.com` (preferred — covers all variants).
