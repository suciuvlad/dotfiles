...
People, brands, tools, and competitors relevant to Demo Growth Co's site. Entity notes hold the canonical reference for each — when a flow or decision mentions an entity, the entity note is the single source of truth for who/what they are and why they matter.

## People

- [[Demo Growth Co]] — site owner
- (Additional named experts and stakeholders are added by the skill if they surface in audit / SERP data)

## Brands

- [[Demo Growth Co]] — the site itself
