...
Domain: `https://www.example.com`. **Owned by [[Demo Growth Co]].** The site operates under the **saas** business model — see the active overlay at `[[Business Type Overlay]]` for revenue model details.
...
- Geographic / market scope: B2B SaaS workflow automation (refine with Demo Growth Co).
- Topic scope: TBD — to be inferred from sitemap + page-type analysis, then confirmed with Demo Growth Co.
