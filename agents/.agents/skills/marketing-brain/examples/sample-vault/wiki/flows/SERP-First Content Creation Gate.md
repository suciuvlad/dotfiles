...
owner: "Brief author (Demo Growth Co)"
verifier: "Strategy Owner (before publish)"
acceptance_criteria:
...
Owner: brief author (Demo Growth Co for in-sprint pages). Verifier: Strategy Owner before publish — gate evidence is reviewed alongside the draft.
