...
| --- | --- | --- |
| GSC | Verified domain property for `https://www.example.com` (all variants — apex, www, http, https) | Missing |
...
| Asset library | Source-resolution photo / screenshot / case-study library Demo Growth Co controls (for refresh and new hero work) | Missing |
