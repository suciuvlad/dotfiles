...
owner: "Demo Growth Co"
verifier: "Strategy Owner"
acceptance_criteria:
...
Avoid: anything Demo Growth Co (or the named expert) hasn't personally practiced or verified. The information gain bar requires evidence the team can produce.
...
Owner: Demo Growth Co (sprint owner, drafting and publishing). On-the-ground evidence: the named expert (photos, logs, tested artifacts). Verifier: Strategy Owner (gate compliance, information gain audit, schema and link hygiene).
