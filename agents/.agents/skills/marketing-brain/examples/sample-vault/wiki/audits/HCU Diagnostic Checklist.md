...
The page-level and site-level checklist run during Days 1-5 and Days 6-12. Output feeds directly into [[Content Pruning Decision Framework]] and into the prioritization of prune vs refresh vs keep. Niche-agnostic — applies regardless of saas.
