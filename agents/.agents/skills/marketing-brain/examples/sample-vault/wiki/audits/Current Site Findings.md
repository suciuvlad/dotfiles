...
If Demo Growth Co owns multiple domains targeting overlapping intent, surface the coordination question here.
...
The actual cause-mix for https://www.example.com is TBD pending audit.
