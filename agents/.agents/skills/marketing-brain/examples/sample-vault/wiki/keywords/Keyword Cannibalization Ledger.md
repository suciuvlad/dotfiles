...
- Sister-site cannibalization (two of Demo Growth Co's domains both ranking for the same intent).

## Process notes

- Each row is reserved on the date the skill or Demo Growth Co adds it. Verified date updates whenever the SERP is rechecked.
