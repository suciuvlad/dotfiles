...
- One site only: `https://www.example.com`.
- Any other sites Demo Growth Co owns are explicitly out of scope for this sprint, regardless of niche or condition.
...
- Over-promising specific numbers erodes trust between Demo Growth Co and Strategy Owner and pushes the work toward cosmetic refreshes that look productive but do not address the underlying trust drag.
- Honest scope-setting upfront also gives Demo Growth Co permission to prune aggressively when the audit calls for it, instead of hoarding off-niche pages out of fear of losing residual traffic.

## Acceptance

Demo Growth Co acknowledges this scope before the sprint starts. Acknowledgement recorded in `[[Log]]` with date.

## Related

- Operational decision tree: [[Content Pruning Decision Framework]]
- Hypothesis driving the diagnostic: [[Pre-Audit Hypothesis]]
- Onboarding sequence Demo Growth Co follows: [[Start Here]]
