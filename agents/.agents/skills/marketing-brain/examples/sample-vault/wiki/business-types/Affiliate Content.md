...
- **Sister-site cannibalization** — if Demo Growth Co owns multiple domains targeting overlapping intent, do not let them compete head-to-head on the same SERP. Coordinate intent ownership.
...
- [[E-E-A-T for saas]] — the trust dimensions specific to affiliate-content sites.
