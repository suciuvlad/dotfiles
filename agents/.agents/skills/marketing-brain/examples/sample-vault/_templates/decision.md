...
const owner = await tp.system.prompt("Owner (who executes)", "Demo Growth Co");
const verifier = await tp.system.prompt("Verifier (who gates acceptance)", "Strategy Owner");
